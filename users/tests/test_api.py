...
class TestUserApi(TokenTestCase):
    ...
    def test_get_info(self):
        ...
        auth = f"JWT {self.create_token(user)}"
...
gplus_user_data = {
    ...
    "name": {"givenName": "James", "familyName": "Mitchell"},
    "id": "12345678",
    "isPlusUser": True,
    "verified": False,
    "cover": {
    ...
    "language": "en_GB",
    "organizations": [{"primary": True, "title": "Web developer", "type": "work"}],
...
class TestSocialAuth(TestCase):
    ...
    def test_gplus_auth(self, mock):
        ...
        response = self.client.get(
            f"/api/v1/auth/register-by-token/{self.backend}",
